...
$(function () {
  _reactDom2.default.render(_react2.default.createElement(_components.MapToolbar, null), document.getElementById("MapToolbar"));
});
/**
 * 注册初始化页面的事件
 * @property bindClick
...
var MapToolbar = function (_Component) {
    _inherits(MapToolbar, _Component);

    function MapToolbar(props) {
        _classCallCheck(this, MapToolbar);

        var _this = _possibleConstructorReturn(this, (MapToolbar.__proto__ || Object.getPrototypeOf(MapToolbar)).call(this, props));
    ...
    _createClass(MapToolbar, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'map-toobar' },
                _react2.default.createElement(
                    'div',
                    { title: '\u653E\u5927', className: this.state.title == '放大' ? 'active' : '' },
                    _react2.default.createElement('span', { className: 'icon-zoom-in icon-2x' })
                ),
                _react2.default.createElement(
                    'div',
                    { title: '\u7F29\u5C0F', className: this.state.title == '缩小' ? 'active' : '' },
                    _react2.default.createElement('span', { className: 'icon-zoom-out icon-2x' })
                ),
                _react2.default.createElement(
                    'div',
                    { title: '\u5B9A\u4F4D', className: this.state.title == '定位' ? 'active' : '' },
                    _react2.default.createElement('span', { className: 'icon-screenshot icon-2x' })
                ),
                _react2.default.createElement(
                    'div',
                    { title: '\u8FC1\u79FB\u56FE', onClick: this.transferMap.bind(this), className: this.state.title == '迁移图' ? 'active' : '' },
                    _react2.default.createElement('span', { className: 'icon-h-sign icon-2x' })
                ),
                _react2.default.createElement(
                    'div',
                    { title: '\u52A0\u5FEB', onClick: this.fast.bind(this), className: this.state.title == '加快' ? 'active' : '' },
                    _react2.default.createElement('span', { className: 'icon-fast-forward icon-2x' })
                )
            );
        }
        /**
        ...
        key: 'transferMap',
        value: function transferMap() {
            _reactDom2.default.render(_react2.default.createElement(TransferCanvas, { closeMap: this.closeMap.bind(this) }), document.getElementById("map-main"));
            //$("#transferMap").removeClass("extends-transfer-map-hidden");
            this.setState({
                title: "迁移图"
            });
            var resolutions = _config2.default.basemap.resolutions;
            var crs = new L.Proj.CRS(_config2.default.crs.code, _config2.default.crs.defs, {
                origin: _config2.default.basemap.origin,
                resolutions: resolutions
            });
            this.map = L.map("main", {
                crs: crs,
                center: _config2.default.basemap.center,
                zoom: _config2.default.basemap.zoom,
                minZoom: _config2.default.basemap.minZoom,
                maxZoom: _config2.default.basemap.maxZoom,
                zoomControl: true,
            ...
            var basemap = new L.esri.TiledMapLayer({
                url: _config2.default.basemap.url
            });
...
var TransferCanvas = function (_Component2) {
    _inherits(TransferCanvas, _Component2);

    function TransferCanvas() {
        _classCallCheck(this, TransferCanvas);

        return _possibleConstructorReturn(this, (TransferCanvas.__proto__ || Object.getPrototypeOf(TransferCanvas)).apply(this, arguments));
    }

    _createClass(TransferCanvas, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement('span', { id: 'transfer-map-close', className: 'icon-remove-circle icon-3x extends-transfer-map-close', title: '\u5173\u95ED\u7A97\u53E3', onClick: this.props.closeMap }),
                _react2.default.createElement('canvas', { id: 'canvas-symbol', className: 'extends-transfer-map-canvas' }),
                _react2.default.createElement('canvas', { id: 'canvas-rippling', className: 'extends-transfer-map-canvas' }),
                _react2.default.createElement('canvas', { id: 'canvas-move-point', className: 'extends-transfer-map-canvas' }),
                _react2.default.createElement('canvas', { id: 'canvas-arc', className: 'extends-transfer-map-canvas' })
            );
        }
    }]);
...
var Canvas = function () {
    ...
    _createClass(Canvas, [{
        ...
        value: function initCanvas() {
            ...
            try {
                for (var _iterator = canvasId[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    var id = _step.value;
        ...
        value: function highLight(e) {
            ...
            L.esri.identifyFeatures({
                url: _config2.default.basemap.url
            }).on(this.map).at(latLng).layers('visible:0').run(function (error, featureCollection, response) {
                if (response.results[0] && response.results[0].attributes["NL_NAME_1"] != _this3.symbolText) {
                    _this3.geoList = response.results[0].geometry.rings;
                    _this3.geoText = [response.results[0].attributes["CENTER_Y"], response.results[0].attributes["CENTER_X"]];
                    var text = response.results[0].attributes["NL_NAME_1"].split('|');
                    _this3.symbolText = text.length > 1 ? text[1] : text[0];
                } else _this3.geoList = [];
                var color = d3.schemeCategory20[Math.floor(Math.random() * 20)];
                _this3.color = _this3.hexToRgb(color, 0.9);
                _this3.drawSymbol();
            });
        }
        ...
        key: 'hexToRgb',
        value: function hexToRgb(str, alpha) {
        ...
        value: function drawSymbol() {
            ...
            ctx.beginPath();
            var pxList = [];
            pxList = this.geoList.map(function (geo) {
                var list = geo.map(function (point) {
                    return _this4.map.latLngToContainerPoint([point[1], point[0]]);
                });
                return list;
            });
            ...
            for (var i = 0; i < pxList.length; i++) {
                for (var j = 0; j < pxList[i].length; j++) {
                    if (j == 0) ctx.moveTo(pxList[i][j].x, pxList[i][j].y);else {
        ...
        value: function startDraw() {
            ...
            data.endCity.map(function (text, i) {
                if (_this5.cityGeo[text]) {
                    p2 = _this5.map.latLngToContainerPoint(L.latLng([_this5.cityGeo[text][1], _this5.cityGeo[text][0]]));
                    var radius = Math.sqrt(Math.pow(p2.x - p1.x, 2) + Math.pow(p2.y - p1.y, 2));
                    var center = _this5.calRadius(p1.x, p1.y, p2.x, p2.y);
                    var coord = _this5.coordAngle(center, p1, p2);
        ...
        key: 'drawCircle',
        value: function drawCircle(startData, RipplingData) {
            var _this6 = this;
            ...
            var render = function render() {
                ...
                try {
                    for (var _iterator2 = RipplingData[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                        ...
                        _this6.drawArrow(ctx, prePoint.x, prePoint.y, nowPoint.x, nowPoint.y, 30, 10, color);
                        ctx.font = "bold 14px Courier New";
                        //设置字体填充颜色
                        ctx.fillStyle = color;
        ...
        key: 'calRadius',
        value: function calRadius(x1, y1, x2, y2) {
        ...
        key: 'coordAngle',
        value: function coordAngle(center, p1, p2) {
            var startPoint = {
                x: p1.x - center.x,
                y: center.y - p1.y
            },
        ...
        key: 'calAngle',
        value: function calAngle(p) {
            //返回的角度都以逆时针计算
            switch (p.x > 0) {
                case true:
                    if (p.y > 0) return Math.PI * 2 - Math.atan(p.y / p.x); //第一象限
                    else if (p.y < 0) {
        ...
        key: 'drawRippling',
        value: function drawRippling(RipplingData) {
        ...
        key: 'renderRippling',
        value: function renderRippling(RipplingData) {
            var canvas = document.getElementById("canvas-rippling");
            ...
            try {
                for (var _iterator3 = RipplingData[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
        ...
        key: 'drawMove',
        value: function drawMove(startData, RipplingData) {
            var _this7 = this;
            ...
            this.timer1 = setInterval(function () {
                ...
                backCtx.drawImage(canvas, 0, 0, canvas.width, canvas.height);
                context.clearRect(0, 0, canvas.width, canvas.height);
                _this7.renderMove(context, startData, RipplingData);
                context.drawImage(backCanvas, 0, 0, canvas.width, canvas.height);
            }, 10);
        }
    }, {
        key: 'renderMove',
        value: function renderMove(context, startData, RipplingData) {
            var len = RipplingData.reduce(function (front, back) {
            ...
            try {
                for (var _iterator4 = RipplingData[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                    ...
                    var currentX = startData.x + dx,
                        currentY = startData.y - dy;
        ...
        key: 'drawArrow',
        value: function drawArrow(ctx, fromX, fromY, toX, toY, theta, headlen, color, width) {
...
var Project_config = {
  ...
  basemap: {
     ...
     * @type {String}
    */
    url: "http://192.168.0.158:6080/arcgis/rest/services/China/MapServer",
    /**
     * 原点
     * @property origin
     * @type {Array}
     ...
     * @type {Array}
     */
    fullExtent: [73.55770111084013, 18.159305572509766, 134.77392578125034, 53.560859680175895],
    /**
     * 分辨率
     * @property resolutions
     * @type {Array}
     */
    resolutions: [0.07614275218656896, 0.03807137609328448, 0.01903568804664224, 0.00951784402332112, 0.00475892201166056, 0.00237946100583028],
    /**
     * 地图中心
     * @property center
     * @type {Array}
     */
    center: [35.86008262634283, 104.16581344604523],
    /**
     * 最大级数
     * @property maxZoom
     * @type {String}
...
exports.default = Project_config;
exports.cityGeo = cityGeo;
